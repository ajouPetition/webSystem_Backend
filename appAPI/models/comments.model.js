...
// 게시물별 댓글 조회
comments.findByPostID = function(id, result){
...
comments.create = function(newComment, result){
    let data = [newComment.commentID, newComment.postID, newComment.userID, newComment.date, newComment.content]
    let sql = 'INSERT INTO comments(commentID, postID, userID, date, content) VALUES(?, ?, ?, ?, ?)'
